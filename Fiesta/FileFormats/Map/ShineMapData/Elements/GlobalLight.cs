...
using Color = Fiesta.FileFormats.Map.ShineMapData.Elements.Color;
...
namespace Fiesta.FileFormats.Map.ShineMapData.Elements
{
	...
	public class GlobalLight
	{
		...
		public GlobalLight(string[] contents, int linePos)
		{
			Color = new Color();
			...
			if (contents[0] != "GlobalLight")
			{
				throw new System.Exception($"Please make sure you have a proper GlobalLight header ({contents[0]})!");
			}
